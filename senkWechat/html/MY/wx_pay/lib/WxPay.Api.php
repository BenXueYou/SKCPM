 ...
 * 参数三：随机字符串nonce_str
 * 参数四：签名sign
 * 参数五：收款方银行卡号：enc_bank_no
 * 参数六：收款方姓名：enc_true_name
 * 参数七：收款方开户行：bank_code
 * 参数八：付款金额：amount
 * 参数九：付款说明:desc
 */
	public static function mmpaysptrans_pay_bank($inputObj){
 ...
 * 参数九：付款说明:desc
 */
	public static function wx_transfer($inputObj)
	{
		# code...
...
private static function postTestXmlCurl($xml, $url, $useCert = false, $second = 30)
  {
    $ch = curl_init();
    //设置超时
