...
//日志函数
	...
	public function httpGet($url) {
    	...
    	$url = "http://139.129.194.195:8080/SuperBackManage/wechatUserManager/logger?content=".$url;
...
//企业付款到银行卡
class WxpayBankOrder extends WxPayDataBase{
...
{	
	...
	**/
	...
	/**
	* 设置trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识。企业付款前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 
	* @param string $value 
	**/
	public function SetOpenid($value)
	{
	...
	/**
	* 获取trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识。企业付款前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 的值
	* @return 值
	**/
	public function GetOpenid()
	{
	...
	/**
	* 判断trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识。企业付款前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 是否存在
	* @return true 或 false
	**/
	public function IsOpenidSet()
	{
