...
<head>
	...
	<link rel="stylesheet" href="Order/css/mui.min.css">
	<link href="http://wx.senk.com.cn/senkWechat//CSS/circle.css" rel="stylesheet" type="text/css"/>
	<script type="text/javascript" src="http://wx.senk.com.cn/senkWechat/JS/jquery-3.0.0.min.js" ></script>
		<style>
			html,
			body {
	...
	<body>
		<div class="mui-content">
			<div id="slider" class="mui-slider mui-fullscreen">
				<div id="sliderSegmentedControl" class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
					<div class="">
						<a class="mui-control-item my-menu-item mui-active" href="#item1mobile">
							 支付记录
						</a>
						<a class="my-menu-item mui-control-item" href="#item2mobile">
							充电记录
						</a>
					</div>
				</div>
		...
		<script src="Order/js/mui.min.js"></script>
		<script src="Order/js/mui.pullToRefresh.js"></script>
		<script src="Order/js/mui.pullToRefresh.material.js"></script>
		<script src="../JS/my-js/chargeRecorder.js" type="text/javascript" charset="utf-8"></script>
			...
			(function($) {
				...
				$.ready(function() {
					...
					function getPayRecord(urlM,openId,index,callback){
						var fragment;
						ChargeRecord.getPayRecord(urlM,openId,index,function(data){
				...
				function getChargeRecorder(urlM,openId,index,callback){
					var fragment;
					ChargeRecord.getChargeRecord(urlM,openId,index,function(data){
						...
						for (var i = 0; i < data.length; i++) {
							...
							li.setAttribute('value',i);
							li.value = i;
							var ttt = chargeRecorder[i].chargeTimeSpan;
			                var tt = ttt  / 60;
