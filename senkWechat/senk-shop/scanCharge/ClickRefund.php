...
// alert(des);
var money = "<?php echo $_REQUEST['refund_fee']?>";
if(money == "null" || money == 0 || money == "0" || money == null){
	money = 0;
}else{
    money = money/100;
}
...
console.log("===="+"<?php echo $_REQUEST["out_trade_no"]?>"+"====="+timeStamp+"====="+"<?php echo $_REQUEST['refund_fee']?>"+"====="+status+"========"+des);
sendRefundRes();
