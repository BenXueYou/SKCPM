 ...
 * @LastEditTime: 2021-09-09 17:44:57
 */
...
// 设备管理
const ChargePile = () => import(/* webpackChunkName: "gdevice" */ '@/pages/charge-pile/index');
const ChargeAddress = () => import(/* webpackChunkName: "device" */ '@/pages/charge-address/index');
const ChargeFactory = () => import(/* webpackChunkName: "device" */ '@/pages/charge-factory/index');
const ChargeStation = () => import(/* webpackChunkName: "device" */ '@/pages/charge-station/index');
// 用户管理
// const AppUser = () => import(/* webpackChunkName: "userManage" */ 'index@/pages/userManage/appUser');
