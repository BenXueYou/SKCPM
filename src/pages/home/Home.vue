    ...
    <div class="bodyBox">
      <div class="topMenu"
        ...
        <el-table :data="[tableData[0]]"
                  ...
                  border
                  style="width: 100%">
          <el-table-column prop="chargeStationCount"
                           label="充电站总数"></el-table-column>
          <el-table-column prop="chargePileCount"
                           label="充电桩总数"></el-table-column>
          <el-table-column prop="chargePileDcCount"
                           label="直流桩总数"></el-table-column>
          <el-table-column prop="chargePileAcCount"
                           label="交流桩总数"></el-table-column>
          <el-table-column prop="weChatUserCount"
                           label="注册用户数"></el-table-column>
          <el-table-column prop="cardCount"
                           label="卡用户数"></el-table-column>
        </el-table>
      </div>
      <div class="topMenu flex-spa"
           style="margin: 15px 0;">
        <div class="flex-sbw">
          ...
          <div class="flex-sbw-div topTitleTxt flex-sbw-item">
            ...
            <el-select class="left-space time-interal"
                       ...
                       placeholder="统计类型"
                       size="small">
              <el-option v-for="item in staticTypeOptions"
                         :key="item.typeStr"
                         :label="item.typeName"
        ...
        <el-button type="primary"
                   @click="queryBtnAct"
                   style="margin:5px 12px;">查询</el-button>
      </div>
      <el-container>
        <el-main>
...
export default {
  ...
  methods: {
    ...
    drawLine() {
      ...
      this.$refs.canvsWidth.$el.style.width = w - 350 + "px";
