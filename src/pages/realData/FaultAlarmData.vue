    ...
    <div class="bodyBox">
        ...
        <div class="flex-st">
          <div class="flex-sbw-div">
            ...
            <el-select class="left-space time-interal"
                       ...
                       placeholder="确认状态"
                       size="small">
              <el-option v-for="item in checkedOptions"
                         :key="item.typeStr"
                         :label="item.typeName"
      ...
      <div class="tableBox">
        <el-table :data="tableData"
          ...
          <el-table-column prop="checkMode"
                           label="确认模式"
                           width="180">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button v-if="!scope.row.checkState"
                         @click="handleClick(scope.row)"
                         type="text"
                         size="small">确认</el-button>
              <el-button v-else
                         type="text"
                         size="small">已确认</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
