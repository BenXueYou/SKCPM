<template>
	...
	>
		...
		<div class="bodyBox">
			...
			<div class="tableBox">
				<el-table :data="tableData" stripe border style="width: 100%">
					...
					<el-table-column prop="timeIntervalCount" label="有效时段"></el-table-column>
					<el-table-column prop="serviceTip" label=" 服务费"></el-table-column>
					<el-table-column prop="jprice" label="尖电价"></el-table-column>
					<el-table-column prop="fprice" label="峰电价"></el-table-column>
					<el-table-column prop="pprice" label="平电价"></el-table-column>
					<el-table-column prop="gprice" label="谷电价"></el-table-column>
					<el-table-column prop="ti1Start" label="时段1起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti1Id" label="时段1类型" width="100"></el-table-column>
					<el-table-column prop="ti2Start" label="时段2起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti2Id" label="时段2类型" width="100"></el-table-column>
					<el-table-column prop="ti3Start" label="时段3起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti3Id" label="时段3类型" width="100"></el-table-column>
					<el-table-column prop="ti4Start" label="时段4起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti4Id" label="时段4类型" width="100"></el-table-column>
					<el-table-column prop="ti5Start" label="时段5起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti5Id" label="时段5类型" width="100"></el-table-column>
					<el-table-column prop="ti6Start" label="时段6起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti6Id" label="时段6类型" width="100"></el-table-column>
					<el-table-column prop="ti7Start" label="时段7起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti7Id" label="时段7类型" width="100"></el-table-column>
					<el-table-column prop="ti8Start" label="时段8起始时刻" width="120"></el-table-column>
					<el-table-column prop="ti8Id" label="时段8类型" width="100"></el-table-column>
		...
		<bill-model-edit :rowData="rowData" :isShow="isShowAddDialog" @onCancel="close" ref="houseTable" />
	</el-row>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    getRowDetail(xhr) {
      this.$PriceAjax
        .getChargePriceDetail({ id: xhr.id })
        .then(res => {
          console.log(res.data);
          if (res.data.success) {
            this.isShowAddDialog = !this.isShowAddDialog;
...
<style>
.BillModel .flex-sbw-item .el-input,
.BillModel .flex-sbw-item .el-input__inner {
	width: 160px;
	height: 32px;
}
.BillModel .el-table__fixed,
.BillModel .el-table__fixed-right {
	box-shadow: 0 0 0px rgba(0, 0, 0, 0.12);
}
.BillModel .el-date-editor.el-input,
.BillModel .el-date-editor.el-input__inner {
	width: 190px;
}
.BillModel .el-input--suffix .el-input__inner {
	padding-right: 10px;
}
.BillModel .el-table__fixed-body-wrapper {
	top: 48px !important;
}
@media screen and (max-width: 1540px) {
	.BillModel .flex-sbw-item {
