		...
		<div class="bodyBox">
			...
			<div class="tableBox">
				<el-table :data="tableData" stripe border style="width: 100%">
					...
					<el-table-column prop="loginId" width="120" label="账号"></el-table-column>
					<el-table-column prop="password" label="密码" show-overflow-tooltip></el-table-column>
					<el-table-column prop="roleId" width="80" label="权限"></el-table-column>
