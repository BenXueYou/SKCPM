<template>
  <el-row class="CardChargeRecord"
    ...
    <div class="bodyBox">
      ...
      <div class="topMenu flex-st"
        ...
        <el-button type="primary"
                   @click="exportBtnAct"
                   style="margin:-5px 10px 0">批量导出</el-button>
        <el-button type="primary"
                   @click="queryBtnAct"
        ...
        <el-button type="primary"
                   class="el-icon-back"
                   @click="backBtnAct"
                   style="margin:-5px 10px 0">返回</el-button>
      </div>
      <div class="tableBox">
        <el-table :data="tableData"
          ...
          <el-table-column prop="chargeStartTime"
                           label="充电开始时间"
                           width="180"></el-table-column>
          <el-table-column prop="chargeEndTime"
                           label="充电结束时间"
                           width="180"></el-table-column>
          ...
          <el-table-column prop="chargeQuantity"
                           label="充电电量"
                           width="120"></el-table-column>
          <el-table-column prop="chargeMoney"
                           label="充电总金额"
                           width="100"></el-table-column>
          <el-table-column prop="csName"
                           label="充电站"
                           width="150"></el-table-column>
          <el-table-column prop="operatorName"
                           label="运营商"
                           width="120"></el-table-column>
          <el-table-column prop="chargeFinishedFlag"
                           label="交易状态"
                           width="100">
    ...
    <charge-record-detail :visible.sync="isShowAddDialog"
                          ...
                          @onCancel="close"
                          ref="houseTable" />
    <charge-record-edit :visible.sync="dialogRecordView"
                        :rowData="rowData"
