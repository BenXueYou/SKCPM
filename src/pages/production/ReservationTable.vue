    ...
    <div class="bodyBox">
      ...
      <div class="tableBox">
        <el-table :data="tableData"
          ...
          <el-table-column prop="reservationName"
                           label="租赁人姓名"></el-table-column>
          <el-table-column prop="reservationPhone"
                           label="租赁人电话"></el-table-column>
          <!-- <el-table-column prop="province"
                           label="余额"></el-table-column> -->
          <el-table-column prop="reservationCar"
                           label="车辆型号"></el-table-column>
          <el-table-column prop="reservationSetNum"
                           label="车座位数"></el-table-column>
          <el-table-column prop="reservationTime"
                           label="预约日期"></el-table-column>
          <el-table-column prop="gmtCreate"
                           label="记录日期"></el-table-column>
