...
<style>
.EnterpriseChargeRecord .flex-sbw-item .el-input,
.EnterpriseChargeRecord .flex-sbw-item .el-input__inner {
	width: 160px;
	height: 32px;
}
.EnterpriseChargeRecord .el-date-editor.el-input,
.EnterpriseChargeRecord .el-date-editor.el-input__inner {
	width: 190px;
}
.EnterpriseChargeRecord .el-input--suffix .el-input__inner {
	padding-right: 10px;
}

@media screen and (max-width: 1540px) {
	.EnterpriseChargeRecord .flex-sbw-item {
